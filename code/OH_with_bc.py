...
plt.yticks([-0.02,0,0.03], [-0.02,0,0.03])

U0cornerwavevec = np.vectorize(U0cornerwave)
xRef = np.linspace(0,1,1000)

# plt.plot(x2,method2.u[method2.M+1,:],'k',x,method.u[method.M+1,:],'k--')
# fig.savefig('Right_boundary_off.eps', bbox_inches='tight')
